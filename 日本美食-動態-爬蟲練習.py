...
driver.get('https://tabelog.com/tw/rstLst/')
...
for area in areas:
    ...
    driver.find_element(By.ID,"js-autocomplete-global-location").send_keys(area)
    
    driver.find_element(By.CSS_SELECTOR , 'input.c-btn.c-btn--primary.global-headline__search-btn').click()
    
    time.sleep(4)
    
    driver.find_element(By.ID , 'js-map-search-sort-trigger').click()
    
    time.sleep(4)
    
    driver.find_element(By.CSS_SELECTOR , "span.js-map-search-sort-target[data-value='rt']").click()
